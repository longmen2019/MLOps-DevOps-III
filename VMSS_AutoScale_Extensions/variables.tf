...
variable "lb_diag_logs" {
  ...
  default     = ["LoadBalancerHealthEvent"]
}
...
#   default     = "/subscriptions/e12adcfa-03e1-4916-bd5a-09418f9235d4/resourceGroups/rg-casual-rodent-rg/providers/Microsoft.OperationalInsights/workspaces/law-longmen"
# }
...
variable "app_or_service_name" {
  description = "Name of the application or service using the Key Vault"
  type        = string
  default     = "myapp"
}

variable "subscription_type" {
  description = "Subscription type (e.g., dev, prod, test)"
  type        = string
  default     = "dev"
}
...
variable "enabled_for_deployment" {
  description = "Allow Key Vault access during VM deployment"
  type        = bool
  default     = true
}
...
variable "enabled_for_template_deployment" {
  description = "Allow Key Vault access during ARM template deployments"
  type        = bool
  default     = true
}
...
variable "grant_access_to_service_principal" {
  description = "Whether to grant access to a service principal (used for conditional resource creation)"
  type        = bool
  default     = true
}

variable "vm_os_type" {
  description = "The operating system type of the VMSS (e.g., 'windows' or 'linux')"
  type        = string
  default = "windows"
}

variable "type_handler_version" {
  description = "The version of the AzureDiskEncryption extension handler"
  type        = string
  default     = "2.2"
}

variable "encrypt_operation" {
  description = "The encryption operation to perform (e.g., 'EnableEncryption')"
  type        = string
  default     = "EnableEncryption"
}

# variable "encryption_key_url" {
#   description = "The URL of the Key Encryption Key (KEK) in Key Vault"
#   type        = string
#   default     = "https://your-keyvault-name.vault.azure.net/keys/your-key-name/your-key-version"
# }

variable "encryption_algorithm" {
  description = "The encryption algorithm to use (e.g., 'RSA-OAEP', 'RSA-OAEP-256')"
  type        = string
  default     = "RSA-OAEP"
}

variable "volume_type" {
  description = "The volume type to encrypt (e.g., 'All', 'OS', 'Data')"
  type        = string
  default     = "All"
}
